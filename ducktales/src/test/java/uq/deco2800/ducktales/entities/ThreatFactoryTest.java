...
public class ThreatFactoryTest extends ApplicationTest{
	
	ThreatFactory threatFactory = new ThreatFactory();
	
	@Test
	public void createLevel1EnemyTest(){
		
	}
	
	@Test
	public void createLevel1EffectTest(){
