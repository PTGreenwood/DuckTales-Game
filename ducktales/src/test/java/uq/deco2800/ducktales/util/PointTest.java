...
public class PointTest {
	...
	public void testCompareTo(){
		...
		Assert.assertEquals("Comparison error (S).", -1, point.compareTo(south));
		...
		Assert.assertEquals("Comparison error (NW).", 1, point.compareTo(northwest));
		Assert.assertEquals("Comparison error (NE).", 1, point.compareTo(northeast));
		Assert.assertEquals("Comparison error (SW).", -1, point.compareTo(southwest));
		Assert.assertEquals("Comparison error (SE).", -1, point.compareTo(southeast));
