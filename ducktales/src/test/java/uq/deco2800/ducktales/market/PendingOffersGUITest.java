...
public class PendingOffersGUITest extends GuiTest {
	...
	public void testOffersInGrid() {
    	...
    	int offersInModel = this.marketManager.getUserOffers().size();
    	
    	Assert.assertTrue("Number of offers for the user in market model " +
    			"does not equal the number of children in allTradesGridPane", 
    	tradesInGrid == offersInModel);
	}
