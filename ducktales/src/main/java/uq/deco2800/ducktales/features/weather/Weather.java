...
/**
 * Main weather class for the game to be extended by subclasses like fire, rain,
 * snow, etc.
 * 
 * Sets the default methods to be inherited.
 * 
 * @author mattyleggy
 *
 */
public abstract class Weather {
	 ...
	 * 
	 * @return true if weather event occurs over water false if weather event
	 ...
	 * && water - isWater()
	 * 
	 * @return true if weather event occurs over both land && water false if
	 *         weather event does not occur over both
	 */
	...
	/**
	 * @return true if an object (e.g. tree) requires an updated sprite false if
	 *         an object does not need an updated sprite
	 */
