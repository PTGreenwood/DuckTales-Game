...
public class Animal extends AgentEntity {
	...
	/**
	 * Sets the hunger state that the animal is spawned with.The animal's
	 * starting hunger level must be between MINSTARTHUNGER and MAXSTARTHUNGER
	 * inclusive.
	 *
	 * @param startingHunger
	 *            The starting hunger level of the animal.
	 */
	...
	/**
	 * Sets the thirst state that the animal is spawned with. The animal's
	 * starting thirst level must be between MINSTARTTHIRST and MAXSTARTHUNGER
	 * inclusive.
	 *
	 * @param startingThirst
	 *            The starting thirst level of the animal.
	 */
	...
	/**
	 * Sets the strength level that the animal is spawned with. The animal's
	 * starting strength level must be between MINSTARTSTRENGTH and
	 * MAXSTARTSTRENGTH inclusive.
	 *
	 * @param startingStrength
	 *            The starting strength level of the animal.
	 */
	...
	/**
	 * Changes the animal's hunger level to the provided value. The animal's
	 * hunger level must always be between 0 and 100 inclusive. Hunger level
	 * equalling 100 will cause negative effects on animal health, while thirst
	 * level equalling 0 means that the animal is not hungry.
	 *
	 * @param newHunger
	...
	/**
	 * Changes the animal's thirst level to the provided value. The animal's
	 * thirst level must always be between 0 and 100 inclusive. Thirst level
	 * equalling 100 will cause negative effects on animal health, while thirst
	...
	/**
	 * Changes the animal's health to the provided value. The animal's health
	 * must always be between 0 and 100 inclusive.
	 *
	 * @param newHealth
	 ...
	 *
	 * @param newDirection
	 *            The string new direction of the animal's movement.
	 */
	 ...
	 *
	 * @param x
	 *            The status of the animal's out of zone state.
	 */
