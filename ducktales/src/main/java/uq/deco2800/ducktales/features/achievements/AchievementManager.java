...
public class AchievementManager {
	...
	private AchievementThreatController threatController = AchievementThreatController.getInstance();
	...
	private void loadPeons() {
		...
		this.loadAchievement("PEONS", "You have many peons to live for eons.",
				this.peonsController.getAchievementPeonsImage());;
				
	}
	/**
	 * Load Threat Achievement in the Achievement GUI.
	 */
	@FXML
	private void loadThreat() {
		this.loadAchievement("THREATS", "You have encountered many threats.",
				this.threatController.getAchievementThreatImage());;
	}
